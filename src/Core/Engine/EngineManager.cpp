...
void EngineManager::OnInitWindowEngine() {
    ...
    shaders.setCompBind3f("particleDensityCS", "minAABB", minAABB);
    shaders.setCompBind3f("particleDensityCS", "maxAABB", maxAABB);
    ...
    shaders.setCompBind3f("particlePhysicsCS", "minAABB", minAABB);
    shaders.setCompBind3f("particlePhysicsCS", "maxAABB", maxAABB);
    ...
    LinkedSpatialHashGrid::initShaders(*this, particles, minAABB, maxAABB, gridSize, numGroupsX, numGroupsY, numGroupsZ);
}
...
void EngineManager::OnUpdateWindowEngine() {
    ...
    LinkedSpatialHashGrid::buildParticlesInteraction(*this, particles, minAABB, maxAABB, gridSize);
    ...
    while(m_TimersList.at(0).getAcc() >= m_TimersList.at(0).getMSPerUpdate()) {
        ...
        //LinkedSpatialHashGrid hashGrid = LinkedSpatialHashGrid::buildParticlesInteraction(*this, particles, minAABB, maxAABB, gridSize);
        //ssboM.enqueueSSBO("particulesSSBO", GL_DYNAMIC_DRAW, hashGrid.getGrid());
        //ssboM.enqueueSSBO("particulesSSBO", GL_DYNAMIC_DRAW, hashGrid.getBuckets());
